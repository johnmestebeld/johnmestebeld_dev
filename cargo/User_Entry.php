	...
	<form method="post">
    	...
    	<table border="0" cellpadding="4" cellspacing="0">
            ...
            <tr>
            	<td>Username </td>
            	<td>
                	<input type="text" name="usertxt" id="textbox" required="required" />
                </td>
            </tr>
            ...
            <tr>
            	<td>Password</td>
            	<td>
                	<input type="text" name="pwdtxt" id="textbox" required="required"/>
                </td>
            </tr>
            ...
            <tr>
            	<td>Type</td>
            	<td>
                	<input type="text" name="typetxt" id="textbox" required="required"/>
                </td>
            </tr>
            ...
            <tr>
            	<td>Note</td>
                <td>
                	<textarea name="notetxt" cols="23" rows="5" required="required"></textarea>
                </td>
            </tr>
